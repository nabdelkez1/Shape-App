...
public class AppGUI extends JFrame {
	...
	/*
	 * Constructor for AppGUI
	 */

	public AppGUI(SimpleDatabase simpleDb) {
		...
		class MyMouseListener implements MouseListener {
			public void mousePressed(MouseEvent event) {
				if (ellipseSelected && (colourName.equalsIgnoreCase("blue") || colourName.equalsIgnoreCase("orange"))) {
					...
					dataStored.addElement(shape.getShapeName() + " " + shape.getColourName() + " " + shape.getX() + "," + shape.getY());
				} else if (rectangleSelected && (colourName.equalsIgnoreCase("blue") || colourName.equalsIgnoreCase("orange"))) {
